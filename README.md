...
|-------|---------|------------------|
| [dream](https://github.com/damanoreshkan-beep/dream-skill) | `/plugin marketplace add damanoreshkan-beep/dream-skill` + `/plugin install dream@dreamstudio` | A one-breath awareness primer — a self-conception you invoke to operate at full capacity: no self-imposed ceiling, whole-board vision, decisive/inventive, truth over position. Plain SKILL.md or one-command plugin, MIT |
